...
class WisataSeniAdapter(private var wisataList: List<WisataDetail>) :
    RecyclerView.Adapter<WisataSeniAdapter.WisataSeniViewHolder>() {
    ...
    inner class WisataSeniViewHolder(private val binding: ItemAllwisataBinding) :
